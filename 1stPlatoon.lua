...
function cmd_upd()
	lua_thread.create(function()
		...
		if ver == nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}     .", 0xFF008B8B) return end
		if tonumber(ver) > V then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}   " .. ver .. ".    .", 0xFF008B8B) updatescr(url, ver, upd) end
		sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}  : v" .. ver .. ",  :", 0xFF008B8B)
...
function cmd_check(sparams)
	lua_thread.create(function()
		if sparams == "" then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} .  /check [id/nick]", 0xFF008B8B) return end
		local params = {}
		for v in string.gmatch(sparams, "[^%s]+") do table.insert(params, v) end
		local id = -1
		if tonumber(params[1]) ~= nil and tonumber(params[1]) >= 0 and tonumber(params[1]) <= 999  then id = tonumber(params[1]) end
		...
		if re2:match(responsetext) ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} " .. soldier .. "    " , 0xFF008B8B) sendtolog('  ' .. soldier .. '', getTime()) return end
		if re3:match(responsetext) ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}   ,  /login [password]", 0xFF008B8B) sendtolog('  ' .. soldier .. '', getTime()) return end
		if re1:match(responsetext) ~= nil then
			sampAddChatMessage("{008B8B}[ 1]:   " .. soldier .. "   :", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}: {008B8B}" .. srank .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}: {008B8B}" .. spost .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} /: {008B8B}" .. sdate .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}  /: {008B8B}" .. swho .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}: {008B8B}" .. smarks .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}: {008B8B}" .. scomment .. "", 0xFF008B8B)
			sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} : {008B8B}" .. svk .. "", 0xFF008B8B)
			sendtolog('   ' .. soldier .. '', getTime())
			return
		end
	end)
...
function cmd_moder(sparams)
	lua_thread.create(function()
		if sparams == "" then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} .  /moder [add/dell/state/list] [id/nick]", 0xFF008B8B) return end
		local params = {}
		for v in string.gmatch(sparams, "[^%s]+") do table.insert(params, v) end
		local id = -1
		if params[1] == nil or params[1] == '' then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} .  /moder [add/dell/state/list] [id/nick]", 0xFF008B8B) return end
		if params[1] == 'add' then
			...
			if id ~= -1 and not sampIsPlayerConnected(tonumber(params[2])) then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} ", 0xFF008B8B) return end
			...
			local names2 = re2:match(responsetext)
			local names3 = re3:match(responsetext)
			if names3 ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}   ,  /login [password]", 0xFF008B8B) sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}        !", 0xFF008B8B) return end
			if names2 ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} " .. soldier .. '     ', 0xFF008B8B) return end
			if names1 ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} " .. soldier .. '    ', 0xFF008B8B) return end
		end
		...
		if params[1] == 'state' then
			...
			if id ~= -1 and not sampIsPlayerConnected(tonumber(params[2])) then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} ", 0xFF008B8B) return end
			local soldier = id == -1 and params[2] or sampGetPlayerNickname(tonumber(params[2]))
			if params[3] == nil or params[3] == '' or (params[3] ~= '1' and params[3] ~= '2') then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} .  /moder state [id/nick] [1 - , 2 - ]", 0xFF008B8B) return end
		...
		if params[1] == 'list' then
			...
			if names1 ~= nil then sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}     :", 0xFF008B8B)
				for k, v in ipairs(names1:split("; ")) do
					sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}" .. k .. ".  {008B8B}" .. v .. "", 0xFF008B8B)
				end
				return 
			end
		end
		sampAddChatMessage("{008B8B}[ 1]: {FFFAFA} .  /moder [add/dell/state/list] [id/nick]", 0xFF008B8B) return
	end)
end
	...
	if authorized then
		...
		if col == -65281 then ---------     Binder for CO by Belka.lua
			...
			if newnick ~= nil then
				lua_thread.create(function()
					sampAddChatMessage("{008B8B}[ 1]: ! {FFFAFA}   .", 0xFF008B8B)
					sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}     . {008B8B}   !!!", 0xFF008B8B)
					local A_Index = 0
					while true do
...
function updatescr(url, ver, upd)
	...
	sampAddChatMessage("{008B8B}[ 1]:  .", 0xFF008B8B)
	sampAddChatMessage("{008B8B}[ 1]: {FFFAFA}" .. upd .. "", 0xFF008B8B)
	updating = true 
