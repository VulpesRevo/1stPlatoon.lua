...
function checkupdate()
		...
		if tonumber(ver) > V then sampAddChatMessage("{008B8B}[Взвод №1]: {FFFAFA}Обнаружена новая версия, скрипт начинает обновление...", 0xFF008B8B) updatescript(url, ver) end
end
